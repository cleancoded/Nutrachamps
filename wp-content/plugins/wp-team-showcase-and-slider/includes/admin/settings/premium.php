	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	     <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Team Showcase and Slider</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Team Showcase and Slider</strong> included in <br /><strong>Essential Plugin Bundle</p>
	     ...
	     <tbody>
			...
			<tr>
			<th>Visual Composer/WPBakery Page Builder Supports <span class="subtext">Use this plugin with WPBakery Page Builder easily</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>		
			<tr>
